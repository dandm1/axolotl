...
def log_websocket(cfg, msg):
    print("Websocket status is:" + str(cfg.do_websockets))
    print("Message is :" + msg)
    if cfg.do_websockets:
        cfg.websocket({"msg": msg})
...
def train(
    *, cfg: DictDefault, cli_args: TrainerCliArgs, dataset_meta: TrainDatasetMeta
    ...
    log_websocket(cfg, "loading tokenizer... {cfg.tokenizer_config or cfg.base_model_config}")
    ...
    if cfg.resume_from_checkpoint is None and cfg.auto_resume_from_checkpoints:
        ...
        if len(possible_checkpoints) > 0:
            ...
            log_websocket(cfg, f"Using Auto-resume functionality to start with checkpoint at {cfg.resume_from_checkpoint}")
    ...
    if peft_config:
        ...
        log_websocket(cfg, f"Pre-saving adapter config to {cfg.output_dir}")
    ...
    log_websocket(cfg, "Starting trainer...")
    if cfg.group_by_length:
        LOG.info("hang tight... sorting dataset for group_by_length")
        log_websocket(cfg, "hang tight... sorting dataset for group_by_length")
